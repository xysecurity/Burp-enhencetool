...
class BurpExtender(IBurpExtender,IHttpListener):
    ...
    def registerExtenderCallbacks(self, callbacks):
        ...
        callbacks.setExtensionName("Get headers")
        ...
        stdout.println("Welcome to get the header")
    ...
    def processHttpMessage(self,toolFlag,messageIsRequest,messageInfo):
        if toolFlag==4:
            ...
            if not messageIsRequest:
                ...
                # print(analyseresponse.getHeaders()[1])
                # print(analyseresponse.getHeaders()[2])
                # print(analyseresponse.getHeaders()[3])
                for i in analyseresponse.getHeaders():
                    print i
                
               
                # if analyseresponse.getHeaders()[0]=="HTTP/1.1 200 OK":
                #     do something
